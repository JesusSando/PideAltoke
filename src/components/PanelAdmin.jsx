...
function AdminProducto() {
  // Estado para manejar el producto que se está editando o agregando
  const [productoEditado, setProductoEditado] = useState({
    id: null,             // ID del producto (null cuando es un nuevo producto)
    nombre: '',           // Nombre del producto
    precio: '',           // Precio del producto
    descripcion: '',      // Descripción del producto
    categoria: '',        // Categoría del producto
    imagen: null,         // Imagen del producto (null cuando no se ha seleccionado)
    imagenPreview: '',    // Vista previa de la imagen seleccionada
  });
  ...
  const handleEdit = (producto) => {
    // Actualiza el estado con los datos del producto seleccionado para editar
    setProductoEditado({
      id: producto.id,
      ...
      imagenPreview: producto.imagen ? URL.createObjectURL(producto.imagen) : '', // Vista previa de la imagen
    });
    setEditando(true); // Cambia el estado a "editando" para mostrar el formulario en modo edición
  };
